...
public class Issue8IntegrationTest extends IntegrationTest{
    ...
    public void init() {
        ...
        content0.setQuote("Взять хотя бы то, что все ныне принятые Представления о мерностных свойствах Пространства-<strong>Времени</strong>" +
        ...
        content1.setQuote("Иначе во <strong>время</strong> Медитаций (о которых будет очень подробно рассказано в одной из следующих книг «Основ») " +
        ...
        content12.setQuote("Принцип уникальности каждой фокусной Конфигурации, структурирующей любую из Формо-систем Миров, который реализуется" +
        ...
        synonym1.setQuote("Наличие у каждой Формо-системы Миров энергоинформационного содержимого или <strong>Памяти</strong>-Мира-О-Былом," +
                " присущего только Фокусной Динамике её Формо-Творцов.");

        synonym2.setUri("ии:пункт:1.0056");
        synonym2.setName(null);
        synonym2.setQuote("Последние между собой резонационно формируют в <strong>индивидуальных ОДС</strong> каждой из Форм Самосознаний узкоспецифические" +
        ...
        synonym3.setQuote("Это осуществляется Формо-Творцами определённых центров головного мозга за счёт ассоциативного обобщения ими характерных признаков" +
